...
class SocietiesControllerTest < ActionController::TestCase
  ...
  test "should create society" do
    assert_difference('Society.count') do
      post :create, society: { abbreviation: @society.abbreviation, description: @society.description, name: @society.name }
    end
  ...
  test "should update society" do
    patch :update, id: @society, society: { abbreviation: @society.abbreviation, description: @society.description, name: @society.name }
    assert_redirected_to society_path(assigns(:society))
  end
